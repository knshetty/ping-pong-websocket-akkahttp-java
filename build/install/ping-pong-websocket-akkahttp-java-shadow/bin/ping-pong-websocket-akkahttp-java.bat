...
set CLASSPATH=%APP_HOME%\lib\ping-pong-websocket-akkahttp-java-all.jar

@rem Execute ping-pong-websocket-akkahttp-java
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %PING_PONG_WEBSOCKET_AKKAHTTP_JAVA_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
